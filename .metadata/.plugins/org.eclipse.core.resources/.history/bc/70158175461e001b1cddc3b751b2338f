...
public class Principal {
	...
	public static void main(String[] args) {
		Carta cartaTipo = new Carta ("Superman");
		Atributo atributo1cartaTipo = new Atributo("Velocidad", 200.0);
		Atributo atributo2cartaTipo = new Atributo("Fuerza", 500.0);
		cartaTipo.addAtributo(atributo1cartaTipo);
		cartaTipo.addAtributo(atributo2cartaTipo);
		
		Mazo mazo = new Mazo (cartaTipo);
